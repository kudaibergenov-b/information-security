...
smtp_port = 587
sender_email = "kudaybergenov12@gmail.com"  # Replace with your email address
sender_password = "kjgh cicw cfex byzd"     # Replace with your email password or app-specific password
receiver_email = "kudaybergenov12@gmail.com"  # Replace with the recipient's email
...
<body>
  ...
  <script>
       function redirectToPage() {
           window.open('login.html', '_blank'); // Opens in a new tab
       }
   </script>
</body>
</html>
